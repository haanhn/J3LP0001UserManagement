...
public class ServletInsertPromotion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String description = request.getParameter("name").trim();
    ...
    private PromotionError validatePromoData(String name, String description, String fromDateStr, String toDateStr) {
