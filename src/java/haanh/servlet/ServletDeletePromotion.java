...
public class ServletDeletePromotion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = UrlConstants.SERVLET_VIEW_PROMOTIONS;
        int id = Integer.parseInt(request.getParameter("id"));
        
        try {
            PromotionDAO dao = new PromotionDAO();
            boolean result = dao.deletePromoById(id);
            
            if (result) {
                request.setAttribute(UrlConstants.ATTR_MESSAGE, "Delete Promotion successfully!");
            } else {
